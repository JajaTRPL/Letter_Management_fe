...
export type PlnReviewResponse = {
    application: PlnApplication;
    message?: string;
};

export type PlnApplication = {
    id: number;
    status?: string | null;
...
export type PlnReviewerIdentity = {
    studentName: string;
    nim: string;
    email: string;
};
...
type PlnTextActionsOptions = {
    audience: 'tendik' | 'akademik';
    prefix: string;
    endpointPrefix: string;
    identity: PlnReviewerIdentity;
};
...
export function buildPlnReviewerView(
    app: PlnApplication,
    options: PlnViewOptions,
): ReviewerShellView {
    ...
    return {
        title: 'Review Proses Luar Negeri',
        ...
        detailRows: [
            ...
            { label: 'Semester', value: valueOrDash(app.semester) },
            { label: 'Nomor Paspor', value: reviewerShellValueOrDash(app.nomor_paspor) },
...
export function getPlnReviewerIdentity(app: PlnApplication): PlnReviewerIdentity {
    const profile = app.mahasiswa_profile;
    return {
...
export function plnActionSummaryRows(
    app: PlnApplication,
    identity: PlnReviewerIdentity,
): ReviewerShellRow[] {
    return [
        ...
        { label: 'NIM', value: identity.nim },
        { label: 'Jenis Surat', value: 'Proses Luar Negeri' },
        { label: 'Keperluan', value: reviewerShellValueOrDash(app.keperluan) },
    ];
}

export function createPlnTextActions(
    options: PlnTextActionsOptions,
): ReviewerShellAction[] {
...
function renderTimeline(app: PlnApplication): string {
